...
/* Texture dimensions
 *
 * The following constants define the largest viewable area inside the emulator
 * texture. This area equals the emulator texture minus the horizontal and
 * vertical blanking areas. Note that the HBLANK macros measure in DMA cycles.
 * Hence, we need to multiply them by 4 to get the pixel position.
 */
#define CUTOUT_X1 (HBLANK_CNT * 4)
#define CUTOUT_X2 (HPOS_CNT * 4)
#define CUTOUT_Y1 (VBLANK_CNT)
#define CUTOUT_Y2 (VPOS_CNT)
#define CUTOUT_W  (CUTOUT_X2 - CUTOUT_X1)
#define CUTOUT_H  (CUTOUT_Y2 - CUTOUT_Y1)
